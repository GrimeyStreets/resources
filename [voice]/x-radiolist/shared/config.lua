...
Config.RadioChannelsWithName = {
    ["0"] = "Grimey Admin",                                    -- Every channels between 0 and 1 will be named "Admin"
    ["1"] = "Grimey Police",                                   -- Every channels between 1 and 2 will be named "Police"
    ["2"] = "Grimey Ambulance",                                -- Every channels between 2 and 3 will be named "Ambulance"
}
