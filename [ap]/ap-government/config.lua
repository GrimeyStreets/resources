Config = {
	...
	Phone = {GKSPhone = false, QBPhone = true, QuasarPhone = false, QSPRO = false, HighPhone = false, LBPhone = true, Custom = false}, -- Set to the phone you use to true, if you do not have one of these phones then set Custom to true and edit the function in webhooks.lua.
	Interactions = {qbTarget = true, oxTarget = true, qTarget = false, drawText = false}, -- Set the target system to true that you use.
	Banking = {
	  okokbanking = true, -- Set this to true if you own okokbanking and you want the tax to show as a transaction.
...
Config.MayorOptions = {
	funds = {
		...
		withdrawal = {enable = true, min = 100, max = 200000},
		deposit = {enable = true, min = 1000, max = 100000}
	}
}
...
Config.Tax = {
	MayorControl = {
		enable = true,
		TaxTypes = {
	        ["Income"] = {enable = true, mayorControl = true, label = 'Income', icon = 'fa-money-check-dollar', percentageCap = 0.80, percentage = 0.15, AddCityHallFunds = true},		
	        ["Housing"] = {enable = true, mayorControl = false, label = 'Housing', icon = 'fa-house', percentageCap = 0.15, percentage = 0.15, AddCityHallFunds = true},
			["Vehicle"] = {enable = true, mayorControl = false, label = 'Vehicle', icon = 'fa-car', percentageCap = 0.15, percentage = 0.15, AddCityHallFunds = true},
			["Building"] = {enable = true, mayorControl = false, label = 'Building', icon = 'fa-car', percentageCap = 0.15, percentage = 0.15, AddCityHallFunds = true},
			["Item"] = {enable = false, mayorControl = true, label = 'Item', icon = 'fa-cart-shopping', percentageCap = 0.80, percentage = 0.15, AddCityHallFunds = true},
		}
	}
}
