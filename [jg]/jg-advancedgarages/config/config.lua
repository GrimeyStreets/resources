...
Config.GangGaragesAllowInfiniteVehicleSpawns = true -- Gang garages
...
Config.GarageLocations = { -- IMPORTANT - Every garage name must be unique
  ...
  ["Barney Autos"] = {
    coords = vector3(-243.83, -1330.25, 30.98),
    spawn = {vector4(-243.83, -1330.25, 30.98, 261.76), vector4(-243.53, -1333.87, 30.96, 262.49), vector4(-243.10, -1326.80, 30.94, 265.73), vector4(-243.10, -1323.40, 30.94, 262.98)},
    distance = 20,
    type = "car",
    hideBlip = false,
    blip = {
  ...
  ["Casino"] = {
    coords = vector3(-309.46, -897.68, 31.07),
    spawn = {vector4(-309.46, -897.68, 31.07, 345.16), vector4(-313.05, -897.56, 31.07, 346.52), vector4(-316.65, -896.79, 31.07, 346.45), vector4(-320.26, -895.52, 31.07, 345.30), vector4(-311.14, -882.05, 31.07, 170.51), vector4(-307.40, -882.69, 31.07, 164.11)},
    distance = 20,
    type = "car",
    hideBlip = false,
    blip = {
  ...
  ["Beauty Trap"] = {
    coords = vector3(253.50, -1521.96, 29.14),
    spawn = {vector4(253.50, -1521.96, 29.14, 22.01), vector4(256.74, -1520.40, 29.14, 18.81), vector4(250.50, -1523.70, 29.14, 29.16), vector4(247.25, -1525.22, 29.14, 32.53)},
    distance = 20,
    type = "car",
    hideBlip = false,
    blip = {
...
Config.JobGarageLocations = { -- IMPORTANT - Every garage name must be unique
  ...
  ["Police"] = {
    coords = vector3(450.31, -1020.14, 24.45),
    spawn = vector4(450.31, -1020.14, 24.45, 2.21),
    distance = 15,
    job = {"police"},
    type = "car",
    hideBlip = false,
    ...
    hideMarkers = true,
    markers = { id = 21, size = { x = 0.3, y = 0.3, z = 0.3 }, color = { r = 255, g = 255, b = 255, a = 120 }, bobUpAndDown = 0, faceCamera = 0, rotate = 1, drawOnEnts = 0 },
    vehiclesType = "personal", -- Spawn a basic vehicle from a list
  },
  ["EMS"] = {
    coords = vector3(295.55, -607.15, 43.33),
    spawn = vector4(295.55, -607.15, 43.33, 70.29),
    distance = 15,
    job = {"ambulance"},
    type = "car",
    hideBlip = false,
