return {
	...
	PhoneStore = {
		name = 'Phone Store',
		blip = {
			id = 606, colour = 69, scale = 0.8
		}, inventory = {
			{ name = 'phone', price = 1000 },
			{ name = 'radio', price = 1500 },
			{ name = 'burnerphone', price = 2000 },
			{ name = 'speaker', price = 2500, metadata = {typeId = 1, label = 'Speaker Retro', description = 'Low volume, range and quality.', imageurl = 'https://media.rahe.dev/img/boombox.png'} },
			{ name = 'speaker', price = 3000, metadata = {typeId = 2, label = 'Speaker Vibe', description = 'Good volume, range and quality.', imageurl = 'https://media.rahe.dev/img/speaker1.png'} },
			{ name = 'speaker', price = 4500, metadata = {typeId = 3, label = 'Speaker Beat', description = 'Great volume, range, quality and bass.', imageurl = 'https://media.rahe.dev/img/speaker2.png'} },
			...
			vec3(1.30, -170.83, 57.22),
		}, targets = {
			{
                ped = `s_m_y_strvend_01`,
                scenario = 'WORLD_HUMAN_AA_COFFEE',
                loc = vec3(-0.98, -178.12, 55.41),
                heading = 341.06,
            }
		}
	},
	...
	PoliceArmoury = {
		...
		blip = {
			...
			{ name = 'tracking_bracelet', price = 100 },
			...
			vec3(451.51, -979.44, 29.68)
		}, targets = {
			{
                ped = `s_m_m_armoured_02`,
                scenario = 'WORLD_HUMAN_AA_COFFEE',
                loc = vec3(446.84, -1004.50, 29.71),
                heading = 270.66,
            }
		}
	},
