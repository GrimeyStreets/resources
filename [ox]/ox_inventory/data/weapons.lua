return {
	Weapons = {
		...
		['WEAPON_NOCCAMO'] = {
			label = 'Camo Nocturnal',
			weight = 10,
			durability = 0.01,
			ammoname = 'ammo-rifle'
		},
		['WEAPON_COMPACTANGEL'] = {    --weapon spawn name
			label = 'Compact AR', --name that will show in the inventory
			weight = 10,  --weapons weight
			durability = 0,  --weapons durability, 0 means there is none
			ammoname = 'ammo-rifle2'  --weapons ammo type
		},
		['WEAPON_COMPACTHELLCAT'] = {    --weapon spawn name
			label = 'Compact AR', --name that will show in the inventory
			weight = 10,  --weapons weight
			durability = 0,  --weapons durability, 0 means there is none
			ammoname = 'ammo-rifle2'  --weapons ammo type
		},
		['WEAPON_COMPACTHELL'] = {    --weapon spawn name
			label = 'Compact AR', --name that will show in the inventory
			weight = 10,  --weapons weight
			durability = 0,  --weapons durability, 0 means there is none
			ammoname = 'ammo-rifle2'  --weapons ammo type
