...
Queries.Users.Search = [[
    ...
    LEFT JOIN lbtablet_police_profiles p ON p.id = u.character_id
...
Queries.Vehicles = {}
Queries.Vehicles.SelectModelByPlates = "SELECT plate, model FROM lbtablet_registration_vehicles WHERE plate IN (?)"
