...
function getSocietyMoney()
    if GetResourceState('okokBanking') == 'started' then
        return exports['okokBanking']:GetAccount('khusland')
    end
    if Config.SocietyInManagement then
        return exports['qb-management']:GetAccount('khusland')
    else
        return exports['qb-banking']:GetAccountBalance('khusland')
    end
end

function addSocietyMoney(money)
    if GetResourceState('okokBanking') == 'started' then
        exports['okokBanking']:AddMoney('khusland', money)
        return
    end
    if Config.SocietyInManagement then
        exports['qb-management']:AddMoney('khusland', money)
    else
        exports['qb-banking']:AddMoney('khusland', money)
    end
end

function removeSocietyMoney(money)
    if GetResourceState('okokBanking') == 'started' then
        exports['okokBanking']:RemoveMoney('khusland', money)
        return
    end
    if Config.SocietyInManagement then
        exports['qb-management']:RemoveMoney('khusland', money)
    else
        exports['qb-banking']:RemoveMoney('khusland', money)
    end
end
