...
AddEventHandler('ak47_qb_khusland:smoke', function()
...
AddEventHandler('ak47_qb_khusland:onuse:kushkrisps', function()
    effectid += 1
    effectHookah()
end)
AddEventHandler('ak47_qb_khusland:onuse:herbaldelightgummies', function()
    effectid += 1
    effectHookah()
end)
AddEventHandler('ak47_qb_khusland:onuse:blazebites', function()
    effectid += 1
    effectHookah()
end)
AddEventHandler('ak47_qb_khusland:onuse:chroniccrunchcookies', function()
    effectid += 1
    effectHookah()
end)
AddEventHandler('ak47_qb_khusland:onuse:hightimebrownies', function()
    effectid += 1
    effectHookah()
end)

--bar effect
AddEventHandler('ak47_qb_khusland:ondrink:cocktail', function()
    effectid += 1
    effectHookah()
end)
AddEventHandler('ak47_qb_khusland:ondrink:champagne', function()
    effectid += 1
    effectHookah()
end)
AddEventHandler('ak47_qb_khusland:ondrink:daiquiri', function()
    effectid += 1
    effectHookah()
end)
AddEventHandler('ak47_qb_khusland:ondrink:redwine', function()
    effectid += 1
    effectHookah()
end)
AddEventHandler('ak47_qb_khusland:ondrink:whitewine', function()
    effectid += 1
    effectHookah()
end)
AddEventHandler('ak47_qb_khusland:ondrink:whisky', function()
    effectid += 1
    effectHookah()
end)
AddEventHandler('ak47_qb_khusland:ondrink:tequilashots', function()
    effectid += 1
    effectHookah()
end)
AddEventHandler('ak47_qb_khusland:ondrink:mojito', function()
    effectid += 1
    effectHookah()
end)
AddEventHandler('ak47_qb_khusland:ondrink:leaflatte', function()
    effectid += 1
    effectHookah()
end)
...
RegisterNetEvent('ak47_qb_khusland:notify')
AddEventHandler('ak47_qb_khusland:notify', function(msg, type)
    QBCore.Functions.Notify(msg, type)
end)

RegisterNetEvent('ak47_qb_khusland:progress')
AddEventHandler('ak47_qb_khusland:progress', function(msg, time)
    lib.progressCircle({
        duration = time,
        label = msg,
    })
