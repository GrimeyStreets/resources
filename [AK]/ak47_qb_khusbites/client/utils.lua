...
AddEventHandler('ak47_qb_khusbites:smoke', function()
...
AddEventHandler('ak47_qb_khusbites:onuse:kushkrisps', function()
    effectid += 1
    effectHookah()
end)
AddEventHandler('ak47_qb_khusbites:onuse:herbaldelightgummies', function()
    effectid += 1
    effectHookah()
end)
AddEventHandler('ak47_qb_khusbites:onuse:blazebites', function()
    effectid += 1
    effectHookah()
end)
AddEventHandler('ak47_qb_khusbites:onuse:chroniccrunchcookies', function()
    effectid += 1
    effectHookah()
end)
AddEventHandler('ak47_qb_khusbites:onuse:hightimebrownies', function()
    effectid += 1
    effectHookah()
end)
...
RegisterNetEvent('ak47_qb_khusbites:notify')
AddEventHandler('ak47_qb_khusbites:notify', function(msg, type)
    QBCore.Functions.Notify(msg, type)
end)

RegisterNetEvent('ak47_qb_khusbites:progress')
AddEventHandler('ak47_qb_khusbites:progress', function(msg, time)
    lib.progressCircle({
        duration = time,
        label = msg,
    })
