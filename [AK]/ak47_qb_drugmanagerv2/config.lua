...
Config.AdminWithLicense = {
    ['license:25925e5e884af1e62502eb9d6b714e2be66b6455'] = true,
}
--Or identifier
...
Config.Commands = {
    ...
    startsell   = 'startsell',   -- event name ("ak47_qb_drugmanagerv2:startsell")
    stopsell    = 'stopsell',    -- event name ("ak47_qb_drugmanagerv2:stopsell")
}
