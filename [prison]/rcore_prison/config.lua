Config = {
    ...
    Solitary = {
        DistanceCheck = 20.0,      -- This is the distance for checking if player is in his solitary cell.
        GuardDistanceCheck = 20.0, -- This is the distance for checking if player is in the guard area.
