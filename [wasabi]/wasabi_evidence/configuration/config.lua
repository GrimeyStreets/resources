...
Config.MaxEvidence = 10 -- Max evidence that can be collected at once prior to going to evidence lab for analyzing
Config.FlashlightRange = 15 -- Default: 15 / Distance one can see evidence with flashlight (MUST BE ABOVE 2)
Config.AutoDestroy = false -- Auto destory evidence after so long (Default 5 * minutes / Set to false if no destroy)
...
-- Copy starting here to add new location
    LSPD = {
        ...
        analyze = {
            coords = vec3(467.80, -1001.74, 34.24), -- Coords for location(If target is not enabled)
            ...
            target = {
                ...
                coords = vec3(467.80, -1001.74, 34.24),
                heading = 181.42,
                width = 2.0,
                length = 1.0,
                minZ = 30.68-0.9,
        ...
        fingerprinting = {
            ...
            coords = vec3(470.77, -1001.64, 34.24), -- Coords for location(If target is not enabled)
            range = 1.8, -- Range to show TextUI (If target is not enabled)
            label = '[E] - Take Suspect\'s Fingerprints', -- TextUI string(If target is not enabled)
            target = {
                enabled = false, -- Enable Target? (Can be customized in cl_customize.lua the target system)
                label = 'Take Suspect\'s Fingerprints',
                coords = vec3(470.77, -1001.64, 34.24),
                heading = 357.17,
                width = 2.0,
                length = 1.0,
                minZ = 26.26-0.9,
        ...
        storage = {
            ...
            coords = vec3(470.73, -997.37, 34.24), -- Coords for location(If target is not enabled)
            range = 1.8, -- Range to show TextUI (If target is not enabled)
            label = '[E] - Access Evidence Storage', -- TextUI string(If target is not enabled)
            target = {
                enabled = false, -- Enable Target? (Can be customized in cl_customize.lua the target system)
                label = 'Access Evidence Storage',
                coords = vec3(470.73, -997.37, 34.24),
                heading = 87.87,
                width = 2.0,
                length = 1.0,
                minZ = 30.68-0.9,
