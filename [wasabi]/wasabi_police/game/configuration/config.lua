...
Config.GrantWeaponLicenses = {
    ...
    minGrade = 3,            -- Min grade to use this function
    menuPosition =
...
Config.GSR = {                 -- Gunshot residue settings
    ...
    autoClean = 1200,           -- (IN SECONDS)How long before residue clears itself? Set to false if undesired to auto clean GSR
...
Config.handcuff = {                             -- Config in regards to cuffing
    ...
    skilledEscape = {
        ...
        difficulty = { 'medium', 'medium', 'hard' } -- Options: 'easy' / 'medium' / 'hard' (Can be stringed along as they are in config)
    },
...
Config.TrackingBracelet = { -- Tracking Bracelet
    ...
    timer = false,    -- Time before player is automatically untracked(Set to false if not desired)
}
...
Config.Locations = {
    LSPD = {
        ...
        cloakroom = {
            ...
            jobLock = 'police',                    -- Allow only one of Config.policeJob listings / Set to false if allow all Config.policeJobs
            coords = vec3(464.33, -1009.82, 30.71), -- Coords of cloakroom
        ...
        personalLocker = {
            ...
            target = {
                ...
                coords = vec3(467.62, -1009.83, 30.21),
                heading = 268.36,
                distance = 2.5,
                width = 2.0,
                length = 1.0,
        ...
        evidenceLocker = {
            ...
            target = {
                ...
                coords = vec3(450.92, -1009.59, 30.71),
                heading = 358.08,
                distance = 2.5,
                width = 2.0,
                length = 1.0,
