...
Config.Locations = {
    Pillbox = {
        ...
        PersonalLocker = {
            ...
            coords = vec(322.46, -594.86, 43.40),   -- Location of where to access personal locker (If target is disabled)
        ...
        CheckIn = {                                      -- Hospital check-in
            ...
            Ped = 's_m_m_scientist_01',                  -- Check in ped
            Coords = vec3(310.08, -563.19, 42.40), -- Coords of ped 310.27, -562.56, 43.40, 159.44
            Distance = 4.85,                             -- Distance to show textUI (If target is not enabled below)
            Heading = 157.99,                             -- Heading of ped
            Cost = 1500,                                  -- Cost of using hospital check-in. Set to false for free
            Duration = 15 * seconds,                     -- Time it takes to spend in hospital bed
            ...
            Target = {
                enabled = true,                          -- Enable Target? (Can be customized in wasabi_bridge/customize/cl_customize.lua the target system)
                label = 'Check In',
                coords = vec3(310.08, -563.19, 42.40),
                heading = 157.99, 
                distance = 5.0,
                width = 2.0,
                length = 1.0,
            ...
            HospitalBeds = {
                --              { coords = vec3(332.62, -587.17, 42.84+0.3), heading = 160.0 },
                { coords = vec3(352.09, -575.25, 43.31), heading = 22.55 },
                { coords = vec3(356.01, -573.62, 43.31), heading = 24.03 },
                { coords = vec3(358.73, -579.73, 43.31),  heading = 205.42 }, 
                { coords = vec3(355.00, -581.50, 43.31), heading = 208.70 },
        ...
        Cloakroom = {
            Enabled = true,
            Coords = vec3(322.15, -600.95, 43.40), -- Coords of cloakroom
        ...
        MedicalSupplies = {                                                     -- EMS Shop for supplies
            ...
            Coords = vec3(320.52, -591.87, 42.40),                       -- Coords of ped/target
            Heading = 160.53,                                                   -- Heading of ped
            Supplies = {                                                        -- Supplies
