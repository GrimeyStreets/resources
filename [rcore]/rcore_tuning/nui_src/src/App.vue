        ...
        methods: {
            ...
            onEvent(event) {
                if (event.data.type == "showui") {
                    this.show(event.data.options, event.data.installed, event.data.ordered, event.data.upgrades, event.data.totalCost, event.data.side, event.data.showPrices, event.data.controllingShop);
            ...
            show(options, installed, ordered, upgrades, total, side, showPrices, controllingShop) {
                ...
                if(showPrices != null) {
                    this.$store.commit('setShowPrices', showPrices)
                }

                if(controllingShop != null) {

                    this.$store.commit('setControllingShop', controllingShop)
                }
