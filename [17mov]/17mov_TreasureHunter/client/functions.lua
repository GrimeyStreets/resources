    ...
    if type == "work" and not hasGear then
        ...
        CreateThread(function()
            while hasGear do
                ...
                AttachEntityToEntity(maskObj, PlayerPed, GetPedBoneIndex(PlayerPed, 12844), 0.0, 0.0, 0.0, 180.0, 90.0, 0.0, 1, 1, false, 0, 2, 1)
                AttachEntityToEntity(tankObj, PlayerPed, GetPedBoneIndex(PlayerPed, 24818), -0.25, -0.25, 0.0, 180.0, 90.0, 0.0, 1, 1, 0, 0, 2, 1)
            end
        end)
