...
Config.OneQuestPercentWorth = 100                   -- How much script should pay for one percent of side quests done.
...
Config.JobCooldown = 15 * 60                        -- 0 minutes cooldown between making jobs (in brackets there's example for 10 minutes)
