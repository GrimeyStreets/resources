...
Config.Price = 100                                -- 2$ per one letter
...
Config.JobCooldown = 10 * 60            -- 0 minutes cooldown between making jobs (in brackets there's example for 10 minutes)
...
Config.Blips = {                                -- Here you can configure Company blip.
    [1] = {
        ...
        Color = 44,
        Scale = 0.8,
        Pos = vector3(-258.77, -841.67, 31.42),
        Label = 'Postman Job'
    },
}
...
Config.SpawnPoint = vector4(-265.24, -853.57, 31.45, 68.56)  -- Vehicle spawn point
